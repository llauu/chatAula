...
export class RegisterPage {
  ...
  constructor(public authService: AuthService, private router: Router, private loadingCtrl: LoadingController, private firestoreService: FirestoreService) {
  ...
  onSubmit() {
    ...
    if (this.registerForm.valid) {
      if(this.registerForm.value.pass === this.registerForm.value.repeatPass) {
        this.authService.createUser(this.registerForm.value.email, this.registerForm.value.pass)
        .then((res: any) => {
          if(res.user.email !== null) {
            ...
            this.firestoreService.createDocument('salaChat/usuarios/usuarios', datosUser, res.user.uid);
